...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
	...
	<let name="vknTckn" value="/edefter:berat/xbrli:xbrl/xbrli:context/xbrli:entity/xbrli:identifier"/>
	<let name="beratTipi" value="/edefter:berat/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:documentInfo/gl-cor:entriesType"/>
	...
	<let name="vergiDetaysizMi" value="/edefter:berat/xbrli:xbrl/xbrli:context/xbrli:entity/xbrli:segment/gl-cor:identifierAuthorityCode"/>
	<pattern id="kok">
		<rule context="*">
	...
	<pattern id="entity">
		<rule context="/edefter:berat/xbrli:xbrl/xbrli:context/xbrli:entity">
			<assert test="$beratTipi='journal' or not(xbrli:segment/gl-bus:numberOfEntries)"> xbrli:segment/gl-bus:numberOfEntries elemanı sadece yevmiye beratında bulunabilir.</assert>
			<assert test="not($beratTipi='journal') or xbrli:segment/gl-bus:numberOfEntries"> Yevmiye beratında xbrli:segment/gl-bus:numberOfEntries zorunlu bir elemandır.</assert>
	...
	<pattern id="measure">
		<rule context="/edefter:berat/xbrli:xbrl/xbrli:unit/xbrli:measure">
			...
			<assert test="not(parent::node()[contains($currencyCodeList, @id)]) or  not(/edefter:berat/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:documentInfo/gl-muc:defaultCurrency) or not(.= concat('iso4217:',parent::node()/@id)) or /edefter:berat/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:documentInfo/gl-muc:defaultCurrency=."> gl-muc:defaultCurrency değeri (<sch:value-of select="/edefter:berat/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:documentInfo/gl-muc:defaultCurrency"/>) hatalıdır. gl-muc:defaultCurrency elemanı varsa değeri xbrli:measure(<sch:value-of select="."/>) ile aynı olmalıdır.</assert>
		</rule>
	</pattern>
	<pattern id="accountingentries">
		<rule context="/edefter:berat/xbrli:xbrl/gl-cor:accountingEntries">
			...
			<assert test="($vergiDetaysizMi='VERGI_DETAYSIZ') or count(gl-cor:entryHeader)=1"> Vergi detayını temsil edecek gl-cor:entryHeader elemanı sayısı 1 olmalıdır.</assert>
			<assert test="not($vergiDetaysizMi='VERGI_DETAYSIZ') or count(gl-cor:entryHeader)=0">Vergi detaysız beratlarda gl-cor:entryHeader elemanı bulunmamalıdır.</assert>
		</rule>
	</pattern>
	<pattern id="entryHeader">
		<rule context="/edefter:berat/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader">
			<assert test="gl-cor:qualifierEntry">gl-cor:qualifierEntry zorunlu bir elemandır.</assert>
		</rule>
	</pattern>
	<pattern id="entryDetail">
		<rule context="/edefter:berat/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader/gl-cor:entryDetail[1]">
			<assert test="gl-cor:lineNumber =1 ">gl-cor:entryHeader elemanının ilk gl-cor:entryDetail elemanının gl-cor:lineNumber değeri 1 olmalıdır.</assert>
		</rule>
	</pattern>
	<pattern id="entryHeader">
		<rule context="/edefter:berat/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader">
			<assert test="gl-cor:qualifierEntry='standard'">Dönem içi değişiklikleri temsil eden gl-cor:entryHeader elemanının gl-cor:qualifierEntry değeri standard olmalıdır.</assert>
			<assert test="count(gl-cor:entryDetail)=10"> Dönem içi değişiklikleri temsil eden gl-cor:entryDetail elemanı sayısı 10 olmalıdır.</assert>
			<assert test="count( gl-cor:entryDetail[gl-cor:account/gl-cor:accountMainID=391 and gl-cor:debitCreditCode='D'])=1">gl-cor:account/gl-cor:accountMainID=391, gl-cor:debitCreditCode=D olan 1 gl-cor:entryDetail elemanı olmalıdır. </assert>
			<assert test="count( gl-cor:entryDetail[gl-cor:account/gl-cor:accountMainID=391 and gl-cor:debitCreditCode='C'])=1">gl-cor:account/gl-cor:accountMainID=391, gl-cor:debitCreditCode=C olan 1 gl-cor:entryDetail elemanı olmalıdır. </assert>
			<assert test="count( gl-cor:entryDetail[gl-cor:account/gl-cor:accountMainID=191 and gl-cor:debitCreditCode='D'])=1">gl-cor:account/gl-cor:accountMainID=191, gl-cor:debitCreditCode=D olan 1 gl-cor:entryDetail elemanı olmalıdır. </assert>
			<assert test="count( gl-cor:entryDetail[gl-cor:account/gl-cor:accountMainID=191 and gl-cor:debitCreditCode='C'])=1">gl-cor:account/gl-cor:accountMainID=191, gl-cor:debitCreditCode=C olan 1 gl-cor:entryDetail elemanı olmalıdır. </assert>
			<assert test="count( gl-cor:entryDetail[gl-cor:account/gl-cor:accountMainID=600 and gl-cor:debitCreditCode='D'])=1">gl-cor:account/gl-cor:accountMainID=600, gl-cor:debitCreditCode=D olan 1 gl-cor:entryDetail elemanı olmalıdır. </assert>
			<assert test="count( gl-cor:entryDetail[gl-cor:account/gl-cor:accountMainID=600 and gl-cor:debitCreditCode='C'])=1">gl-cor:account/gl-cor:accountMainID=600, gl-cor:debitCreditCode=C olan 1 gl-cor:entryDetail elemanı olmalıdır. </assert>
			<assert test="count( gl-cor:entryDetail[gl-cor:account/gl-cor:accountMainID=601 and gl-cor:debitCreditCode='D'])=1">gl-cor:account/gl-cor:accountMainID=601, gl-cor:debitCreditCode=D olan 1 gl-cor:entryDetail elemanı olmalıdır. </assert>
			<assert test="count( gl-cor:entryDetail[gl-cor:account/gl-cor:accountMainID=601 and gl-cor:debitCreditCode='C'])=1">gl-cor:account/gl-cor:accountMainID=601, gl-cor:debitCreditCode=C olan 1 gl-cor:entryDetail elemanı olmalıdır. </assert>
			<assert test="count( gl-cor:entryDetail[gl-cor:account/gl-cor:accountMainID=602 and gl-cor:debitCreditCode='D'])=1">gl-cor:account/gl-cor:accountMainID=602, gl-cor:debitCreditCode=D olan 1 gl-cor:entryDetail elemanı olmalıdır. </assert>
			<assert test="count( gl-cor:entryDetail[gl-cor:account/gl-cor:accountMainID=602 and gl-cor:debitCreditCode='C'])=1">gl-cor:account/gl-cor:accountMainID=602, gl-cor:debitCreditCode=C olan 1 gl-cor:entryDetail elemanı olmalıdır. </assert>
		</rule>
	</pattern>
	<pattern id="entryDetail">
		<rule context="/edefter:berat/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader[gl-cor:qualifierEntry='standard']/gl-cor:entryDetail">
			<assert test="gl-cor:xbrlInfo/gl-cor:xbrlInclude='period_change' ">Dönem içi değişiklikleri temsil eden gl-cor:entryDetail elemanlarının gl-cor:xbrlInfo/gl-cor:xbrlInclude değeri period_change olmalıdır.</assert>
		</rule>
	</pattern>
	<pattern id="entryDetail">
		<rule context="/edefter:berat/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader/gl-cor:entryDetail">
			<assert test="gl-cor:lineNumber">gl-cor:lineNumber zorunlu bir elemandır.</assert>
			<assert test="not(following-sibling::node()) or not(following-sibling::node()/gl-cor:lineNumber) or not(gl-cor:lineNumber) or following-sibling::node()/number(gl-cor:lineNumber) = number(gl-cor:lineNumber) + 1">gl-cor:lineNumber müteselsil bir değere sahip olmalıdır.</assert>
			...
			<assert test="gl-cor:xbrlInfo/gl-cor:xbrlInclude">gl-cor:xbrlInfo/gl-cor:xbrlInclude elemanı zorunlu bir elemandır.</assert>
			<assert test="gl-cor:amount >= 0">Vergi detayında hiçbir tutar 0'dan küçük olamaz.</assert>
	...
	<pattern id="documentinfo">
		<rule context="/edefter:berat/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:documentInfo">
			...
			<assert test="not ($beratTipi='journal') or ( normalize-space(gl-cor:entriesType) = 'journal')">gl-cor:entriesType elemanı yevmiye defteri beratı için 'journal' değerini almalıdır.</assert>
			<assert test="not ($beratTipi='ledger') or ( normalize-space(gl-cor:entriesType) = 'ledger')">gl-cor:entriesType elemanı kebir defteri beratı için 'ledger' değerini almalıdır.</assert>
			<assert test="gl-cor:uniqueID">gl-cor:uniqueID zorunlu bir elemandır.</assert>
			<assert test="not(gl-cor:uniqueID) or not ($beratTipi='journal') or( starts-with(normalize-space(gl-cor:uniqueID),'YEV'))">gl-cor:uniqueID elemanı yevmiye defteri için 'YEV' değeri ile başlamalıdır.</assert>
			<assert test="not(gl-cor:uniqueID) or not ($beratTipi='ledger') or( starts-with(normalize-space(gl-cor:uniqueID),'KEB'))">gl-cor:uniqueID elemanı yevmiye defteri için 'KEB' değeri ile başlamalıdır.</assert>
			...
			<assert test="gl-cor:periodCoveredEnd >= gl-cor:periodCoveredStart">gl-cor:periodCoveredEnd elemanı gl-cor:periodCoveredStart elemanından büyük veya eşit olmalıdır. </assert>
