...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fct="localFunctions" queryBinding="xslt2">
	...
	<title>e-Defter Raporu dokümanlarını kontrol etmek için gerekli olan schematron kuralları</title>
	<let name="vknTckn" value="/edefter:defterraporu/xbrli:xbrl/xbrli:context/xbrli:entity/xbrli:identifier"/>
	<let name="periodCoveredStart" value="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:documentInfo/gl-cor:periodCoveredStart"/>
	...
	<pattern id="kok">
		...
		<rule context="/">
			<assert test="edefter:defterraporu">e-Defter raporu dokümanı edefter:defterraporu ana elemanı ile başlamalıdır.</assert>
		</rule>
	</pattern>
	<pattern id="entity">
		<rule context="/edefter:defterraporu/xbrli:xbrl/xbrli:context/xbrli:entity">
	...
	<pattern id="defterraporu">
		<rule context="/edefter:defterraporu">
	...
	<pattern id="signature">
		<rule context="/edefter:defterraporu/ds:Signature">
	...
	<pattern id="xbrl">
		...
		<rule context="/edefter:defterraporu/xbrli:xbrl/xbrli:context/xbrli:entity/xbrli:identifier">
	...
	<pattern id="measure">
		<rule context="/edefter:defterraporu/xbrli:xbrl/xbrli:unit/xbrli:measure">
			...
			<assert test="not(parent::node()[contains($currencyCodeList, @id)]) or  not(/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:documentInfo/gl-muc:defaultCurrency) or not(.= concat('iso4217:',parent::node()/@id)) or /edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:documentInfo/gl-muc:defaultCurrency=."> gl-muc:defaultCurrency değeri (<sch:value-of select="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:documentInfo/gl-muc:defaultCurrency"/>) hatalıdır. gl-muc:defaultCurrency elemanı varsa değeri xbrli:measure(<sch:value-of select="."/>) ile aynı olmalıdır.</assert>
		</rule>
	</pattern>
	<pattern id="accountingentries">
		<rule context="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries">
			...
			<assert test="count(gl-cor:entryHeader)=1"> Vergi detayını temsil edecek gl-cor:entryHeader elemanı sayısı 1 olmalıdır.</assert>
		</rule>
	</pattern>
	<pattern id="entryHeader">
		<rule context="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader">
			<assert test="gl-cor:qualifierEntry">gl-cor:qualifierEntry zorunlu bir elemandır.</assert>
			<assert test="not(gl-cor:qualifierEntry) or gl-cor:qualifierEntry ='standard'">gl-cor:qualifierEntry elemanının değeri 'standard' olmalıdır.</assert>
			<let name="accountMainIdList" value="gl-cor:entryDetail/gl-cor:account/normalize-space(gl-cor:accountMainID)"/>
			<let name="farkliHesapSayisi" value="count(distinct-values($accountMainIdList))"/>
			<let name="borcEntryDetailSayisi" value="count(gl-cor:entryDetail[gl-cor:debitCreditCode='D'])"/>
			<let name="alacakEntryDetailSayisi" value="count(gl-cor:entryDetail[gl-cor:debitCreditCode='C'])"/>
			<assert test="$farkliHesapSayisi=$borcEntryDetailSayisi">Borç alacak kodu 'C' olan gl-cor:entryDetail elemanı sayısı (<value-of select="$borcEntryDetailSayisi"/>) farklı hesap sayısına (<value-of select="$farkliHesapSayisi"/>) eşit olmalıdır. </assert>
			<assert test="$farkliHesapSayisi=$alacakEntryDetailSayisi">Borç alacak kodu 'D' olan gl-cor:entryDetail elemanı sayısı (<value-of select="$alacakEntryDetailSayisi"/>) farklı hesap sayısına (<value-of select="$farkliHesapSayisi"/>) eşit olmalıdır.</assert>
		</rule>
	</pattern>
	<pattern id="entryDetail">
		<rule context="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader/gl-cor:entryDetail[1]">
	...
	<pattern id="entryDetail">
		<rule context="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader[gl-cor:qualifierEntry='standard']/gl-cor:entryDetail">
	...
	<pattern id="entryDetail">
		<rule context="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader/gl-cor:entryDetail">
			<assert test="gl-cor:lineNumber">gl-cor:lineNumber zorunlu bir elemandır.</assert>
			<assert test="gl-cor:documentApplyToNumber">gl-cor:documentApplyToNumber zorunlu bir elemandır.</assert>
			...
			<assert test="not(gl-cor:documentApplyToNumber) or matches(gl-cor:documentApplyToNumber,'^[0-9][0-9]*$')">gl-cor:documentApplyToNumber elemanı bir sayı olmalıdır.</assert>
			...
			<let name="accountMainID" value="gl-cor:account/gl-cor:accountMainID"/>
			<let name="debitCreditCode" value="gl-cor:debitCreditCode"/>
			<let name="countOfSameAccSameDC" value="count(parent::node()/gl-cor:entryDetail[gl-cor:debitCreditCode=$debitCreditCode and (gl-cor:account/gl-cor:accountMainID)=$accountMainID])"/>
			<assert test="$countOfSameAccSameDC=1"> Hesap Kodu <value-of select="$accountMainID"/> ve borç alacak kodu <value-of select="$debitCreditCode"/> olan 1 tane gl-cor:entryDetail elemanı olabilir; fakat <value-of select="$countOfSameAccSameDC"/> adet var.</assert>
			<assert test="($debitCreditCode='D') or count(parent::node()/gl-cor:entryDetail[gl-cor:debitCreditCode='D' and (gl-cor:account/gl-cor:accountMainID)=$accountMainID])=1"> Hesap Kodu <value-of select="$accountMainID"/> ve borç alacak kodu 'D' olan gl-cor:entryDetail elemanı bulunamamıştır.</assert>
			<assert test="($debitCreditCode='C') or count(parent::node()/gl-cor:entryDetail[gl-cor:debitCreditCode='C' and (gl-cor:account/gl-cor:accountMainID)=$accountMainID])=1"> Hesap Kodu <value-of select="$accountMainID"/> ve borç alacak kodu 'C' olan gl-cor:entryDetail elemanı bulunamamıştır.</assert>
		</rule>
	</pattern>
	<pattern id="documentinfo">
		<rule context="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:documentInfo">
			<assert test="gl-cor:entriesType">gl-cor:entriesType zorunlu bir elemandır.</assert>
			<assert test="not (gl-cor:entriesType) or (gl-cor:entriesType='trialbalance')">Defter raporu dokümanında gl-cor:entriesType elemanının değeri 'trialbalance' olmalıdır.</assert>
	...
	<pattern id="entityinformation">
		<rule context="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entityInformation">
		...
		<rule context="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entityInformation/gl-bus:accountantInformation">
		...
		<rule context="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entityInformation/gl-bus:entityPhoneNumber">
		...
		<rule context="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entityInformation/gl-bus:entityEmailAddressStructure">
		...
		<rule context="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entityInformation/gl-bus:entityWebSite">
